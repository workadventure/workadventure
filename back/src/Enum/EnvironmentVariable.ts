...
const MAX_USERS_PER_ROOM = parseInt(process.env.MAX_USERS_PER_ROOM || '25') || 600;
...
export const SOCKET_IDLE_TIMER = parseInt(process.env.SOCKET_IDLE_TIMER as string) || 3000; // maximum time (in second) without activity before a socket is closed
