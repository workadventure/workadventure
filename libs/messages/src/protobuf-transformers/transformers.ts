 ...
 */
import {AddSpaceUserMessage, UpdateSpaceUserMessage} from "../ts-proto-generated/messages.ts";
import {noUndefinedForKeys, type RequiredFields } from "./undefinedChecker.ts";
