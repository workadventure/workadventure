...
export class ChatConnection implements ChatConnection {
  ...
  public readonly connectionErrorStream =
    this._connectionErrorStream.asObservable();
  ...
  private readonly _xmppSettingsMessageStream = new BehaviorSubject<
    XmppSettingsMessage | undefined
  >(undefined);
  public readonly xmppSettingsMessageStream =
    this._xmppSettingsMessageStream.asObservable();
  ...
  private readonly _xmppConnectionStatusChangeMessageStream =
    new Subject<XmppConnectionStatusChangeMessage_Status>();
  ...
  public constructor(token: string | null, roomUrl: string, uuid: string) {
    ...
    try {
      ...
      this.socket.onmessage = (messageEvent) => {
        ...
        const pusherToIframeMessage = PusherToIframeMessage.decode(
