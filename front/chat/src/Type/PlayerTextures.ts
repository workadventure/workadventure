...
import {
  WokaList,
  WokaPartType,
} from "../Messages/JsonMessages/PlayerTextures";
...
export class PlayerTextures {
  ...
  public getTexturesResources(
    key: PlayerTexturesKey
  ): BodyResourceDescriptionListInterface {
    switch (key) {
  ...
  public getWokaCollectionTextures(
    key: string
  ): BodyResourceDescriptionInterface[] {
  ...
  private getMappedResources(
    category: WokaPartType
  ): BodyResourceDescriptionListInterface {
