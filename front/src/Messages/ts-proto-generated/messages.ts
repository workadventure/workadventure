...
export interface QueryJitsiJwtMessage {
    jitsiRoom: string;
    /** FIXME: rather than reading the tag from the query, we should read it from the current map! */
    tag: string;
}
...
export interface ClientToServerMessage {
    message?:
        ...
        | { $case: "silentMessage"; silentMessage: SilentMessage }
...
const baseSilentMessage: object = { silent: false };

export const SilentMessage = {
    encode(message: SilentMessage, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): SilentMessage {
        const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseSilentMessage } as SilentMessage;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromJSON(object: any): SilentMessage {
        const message = { ...baseSilentMessage } as SilentMessage;
        message.silent = object.silent !== undefined && object.silent !== null ? Boolean(object.silent) : false;
        return message;
    },

    toJSON(message: SilentMessage): unknown {
        const obj: any = {};
        message.silent !== undefined && (obj.silent = message.silent);
        return obj;
    },

    fromPartial<I extends Exact<DeepPartial<SilentMessage>, I>>(object: I): SilentMessage {
        const message = { ...baseSilentMessage } as SilentMessage;
...
const baseCharacterLayerMessage: object = { url: "", name: "" };
...
const baseSetPlayerDetailsMessage: object = { outlineColor: 0, removeOutlineColor: false };
...
export const SetPlayerDetailsMessage = {
    encode(message: SetPlayerDetailsMessage, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
        if (message.outlineColor !== 0) {
            writer.uint32(24).uint32(message.outlineColor);
        }
        if (message.removeOutlineColor === true) {
            writer.uint32(32).bool(message.removeOutlineColor);
        }
        return writer;
    },
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 3:
                    ...
                    break;
                case 4:
                    message.removeOutlineColor = reader.bool();
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromPartial<I extends Exact<DeepPartial<SetPlayerDetailsMessage>, I>>(object: I): SetPlayerDetailsMessage {
        ...
        message.removeOutlineColor = object.removeOutlineColor ?? false;
        return message;
    },
};
...
const baseQueryJitsiJwtMessage: object = { jitsiRoom: "", tag: "" };
...
export const ClientToServerMessage = {
    encode(message: ClientToServerMessage, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
        ...
        if (message.message?.$case === "silentMessage") {
            SilentMessage.encode(message.message.silentMessage, writer.uint32(26).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    message.message = {
                        $case: "silentMessage",
                        silentMessage: SilentMessage.decode(reader, reader.uint32()),
                    };
                    break;
                case 4:
                    message.message = {
    ...
    fromJSON(object: any): ClientToServerMessage {
        ...
        if (object.silentMessage !== undefined && object.silentMessage !== null) {
            message.message = { $case: "silentMessage", silentMessage: SilentMessage.fromJSON(object.silentMessage) };
        }
    ...
    toJSON(message: ClientToServerMessage): unknown {
        ...
        message.message?.$case === "userMovesMessage" &&
            (obj.userMovesMessage = message.message?.userMovesMessage
                ...
                : undefined);
        message.message?.$case === "silentMessage" &&
            (obj.silentMessage = message.message?.silentMessage
                ? SilentMessage.toJSON(message.message?.silentMessage)
                : undefined);
    ...
    fromPartial<I extends Exact<DeepPartial<ClientToServerMessage>, I>>(object: I): ClientToServerMessage {
        ...
        if (
            object.message?.$case === "silentMessage" &&
            object.message?.silentMessage !== undefined &&
            object.message?.silentMessage !== null
        ) {
            message.message = {
                $case: "silentMessage",
                silentMessage: SilentMessage.fromPartial(object.message.silentMessage),
            };
        }
        if (
...
const baseGroupUpdateMessage: object = { groupId: 0, groupSize: 0 };
...
const baseGroupUpdateZoneMessage: object = { groupId: 0, groupSize: 0 };
