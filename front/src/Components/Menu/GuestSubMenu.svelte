    ...
    {#if !canShare}
        <section class="share-url not-mobile">
            ...
            <div class="centered-column">
                <button type="button" class="btn light" on:click={copyLink}>{$LL.menu.invite.copy()}</button>
            </div>
        </section>
    {:else}
        <section class="is-mobile">
            ...
            <button type="button" class="btn light" on:click={shareLink}>{$LL.menu.invite.share()}</button>
        </section>
    {/if}
