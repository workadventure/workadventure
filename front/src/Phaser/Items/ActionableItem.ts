...
export class ActionableItem {
    ...
    private callbacks: Map<string, Array<EventCallback>> = new Map<
        string,
        Array<EventCallback>
    >();
    ...
    public actionableDistance(x: number, y: number): number | null {
        const distanceSquared =
            ...
            (y - this.sprite.y) * (y - this.sprite.y);
    ...
    public emit(
        ...
        this.eventHandler.emitActionableEvent(
            this.id,
            eventName,
            state,
            parameters
    ...
    public on(eventName: string, callback: EventCallback): void {
        let callbacksArray:
            | Array<EventCallback>
            | undefined = this.callbacks.get(eventName);
