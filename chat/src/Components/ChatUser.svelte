...
<div class="group py-3 rounded-lg hover:bg-white/10 transition-all">
    ...
    >
        <div
                class="relative wa-avatar aspect-ratio h-10 w-10 rounded overflow-hidden outline outline-solid outline-contrast-400 group-hover:outline-secondary {!user.active && 'opacity-50'}  cursor-default"
