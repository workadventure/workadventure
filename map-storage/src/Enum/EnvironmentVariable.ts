...
export const S3_THROW_ON_REQUEST_TIMEOUT = env.S3_THROW_ON_REQUEST_TIMEOUT;
export const S3_HEALTH_CHECK_PERIOD = env.S3_HEALTH_CHECK_PERIOD;
export const S3_HEALTH_CHECK_FAILURE_THRESHOLD = env.S3_HEALTH_CHECK_FAILURE_THRESHOLD;
