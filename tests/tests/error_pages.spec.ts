...
test.describe("Error pages @nowebkit", () => {
    ...
    test("successfully displayed for not found public pages", async ({ page }) => {
        await page.goto(publicTestMapUrl("does/not/exist", "error_pages"));
    ...
    test("successfully displayed for not found WAM", async ({ page }) => {
        await page.goto(Map.url("not-found"));
    ...
    test("successfully displayed for resources not found", async ({ page }) => {
        ...
        await page.goto(publicTestMapUrl("tests/MapWithError/error.json", "error_pages"));
