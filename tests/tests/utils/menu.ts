...
class Menu {
    ...
    async openMapEditor(page: Page) {
        ...
        // Let's turn off the camera to avoid interference with area selection in map editor
        await this.turnOffCamera(page);
    ...
    async closeMapEditor(page: Page) {
        ...
        // Let's start the camera again after closing the map editor
        await this.turnOnCamera(page);
    }
