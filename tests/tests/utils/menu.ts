...
class Menu {
    ...
    async closeMapEditor(page: Page) {
        await page.locator('.side-bar-container .side-bar button#CloseMapEditor').click()
        await expect(await page.locator('.side-bar-container .side-bar button#CloseMapEditor')).toBeHidden();
    }
