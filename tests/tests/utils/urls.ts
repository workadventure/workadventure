...
export const play_url = process.env.PLAY_URL ?? (process.env.MAP_STORAGE_PROTOCOL ?? "http") + '://play.workadventure.localhost';
...
export const maps_domain = process.env.MAPS_DOMAIN ?? 'maps.workadventure.localhost';
