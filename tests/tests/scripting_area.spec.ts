...
test.describe("Scripting chat functions @oidc", () => {
  test("can catch event to enter and to leave one area created by the map editor ", async ({
    page,
    browser,
    request,
    browserName,
    ...
    await expect(
      page.getByText("Entered the area name: MyStartZone")
