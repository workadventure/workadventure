...
/**
 * DEPRECATED due to new chat engine (integration with Matrix)
 */
test.describe("Chat @chat", () => {
  ...
  test("main", async ({ page, browser, browserName }, { project }) => {
    ...
    await page.goto(publicTestMapUrl("tests/E2E/livezone.json", "chat"));
    const nickname = getUniqueNickname("A");
    await login(page, nickname, 2, 'en-US');
    ...
    await test.step("all tests of chat", async () => {
      ...
      await login(page2, nickname2, 3, 'en-US');
...
test.describe("Use application into TimeLine @chat", () => {
  ...
  test("main", async ({ page, browser, browserName }, { project }) => {
    ...
    await page
      ...
      .locator("aside.chatWindow")
      .locator(
        '.wa-message-form .actions button.action:has-text("Google Docs")'
      )
      .click();
    await page
      .frameLocator("iframe#chatWorkAdventure")
    ...
    await expect(
      page.frameLocator("#chatWorkAdventure").getByRole("link", {
        name: "https://docs.google.com/document/d/1iFHmKL4HJ6WzvQI-6FlyeuCy1gzX8bWQ83dNlcTzigk/edit?embedded=true",
      })
    ).toContainText(
      "https://docs.google.com/document/d/1iFHmKL4HJ6WzvQI-6FlyeuCy1gzX8bWQ83dNlcTzigk/edit?embedded=true"
    );
    ...
    await page
      ...
      .locator("aside.chatWindow")
      .locator(
        '.wa-message-form .actions button.action:has-text("Google Sheets")'
      )
      .click();
    await page
      .frameLocator("iframe#chatWorkAdventure")
    ...
    await expect(
      page.frameLocator("#chatWorkAdventure").getByRole("link", {
        name: "https://docs.google.com/spreadsheets/d/1SBIn3IBG30eeq944OhT4VI_tSg-b1CbB0TV0ejK70RA/edit?embedded=true",
      })
    ).toContainText(
      "https://docs.google.com/spreadsheets/d/1SBIn3IBG30eeq944OhT4VI_tSg-b1CbB0TV0ejK70RA/edit?embedded=true"
    );
    ...
    await page
      ...
      .locator("aside.chatWindow")
      .locator(
        '.wa-message-form .actions button.action:has-text("Google Slides")'
      )
      .click();
    await page
      .frameLocator("iframe#chatWorkAdventure")
    ...
    await expect(
      page.frameLocator("#chatWorkAdventure").getByRole("link", {
        name: "https://docs.google.com/presentation/d/1fU4fOnRiDIvOoVXbksrF2Eb0L8BYavs7YSsBmR_We3g/edit?embedded=true",
      })
    ).toContainText(
      "https://docs.google.com/presentation/d/1fU4fOnRiDIvOoVXbksrF2Eb0L8BYavs7YSsBmR_We3g/edit?embedded=true"
    );
    ...
    await page
      .frameLocator("iframe#chatWorkAdventure")
      .locator("aside.chatWindow")
      .locator('.wa-message-form .actions button.action:has-text("Youtube")')
      .click();
    await page
      .frameLocator("iframe#chatWorkAdventure")
      .locator("aside.chatWindow")
      .getByPlaceholder("https://www.youtube.com/watch?v=Y9ubBWf5w20")
      .click();
    await page
      .frameLocator("iframe#chatWorkAdventure")
      .locator("aside.chatWindow")
      .getByPlaceholder("https://www.youtube.com/watch?v=Y9ubBWf5w20")
      .fill("https://www.youtube.com/embed/Y9ubBWf5w20?feature=oembed");
    await page
      .frameLocator("iframe#chatWorkAdventure")
      .locator("aside.chatWindow")
      .locator("#timeLine-messageList")
    ...
    await expect(
      page.frameLocator("#chatWorkAdventure").getByRole("link", {
        name: "https://www.youtube.com/embed/Y9ubBWf5w20?feature=oembed",
      })
    ).toContainText("https://www.youtube.com/embed/Y9ubBWf5w20?feature=oembed");
