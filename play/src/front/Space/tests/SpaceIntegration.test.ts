import { AddSpaceUserMessage, UpdateSpaceUserMessage, RemoveSpaceUserMessage, UpdateSpaceMetadataMessage } from "@workadventure/messages";
import { Subject } from "rxjs";
import { describe, expect, it, test, vi , assert } from "vitest";
...
describe("",()=>{
    ...
    it("should be return empty reactiveUser when... ",async ()=>{
        ...
        expect(userToCompare.reactiveUser).toEqual({});
    });
