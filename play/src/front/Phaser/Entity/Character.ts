...
import { PlayerStatusDot } from "../Components/PlayerStatusDot.ts";
import { TalkIcon } from "../Components/TalkIcon.ts";
...
import { getPlayerAnimations, PlayerAnimationTypes } from "../Player/Animation.ts";
import { ProtobufClientUtils } from "../../Network/ProtobufClientUtils";
import { SpeakerIcon } from "../Components/SpeakerIcon.ts";
import { MegaphoneIcon } from "../Components/MegaphoneIcon.ts";
import { StringUtils } from "../../Utils/StringUtils";

import { lazyLoadPlayerCharacterTextures } from "./PlayerTexturesLoadingManager.ts";
import { SpeechBubble } from "./SpeechBubble.ts";
import { SpeechDomElement } from "./SpeechDomElement.ts";
import { ThinkingCloud } from "./ThinkingCloud.ts";
