...
import { UserInputManager } from "../UserInput/UserInputManager.ts";
import { touchScreenManager } from "../../Touch/TouchScreenManager";
import { PinchManager } from "../UserInput/PinchManager.ts";
import { waScaleManager } from "../Services/WaScaleManager.ts";
import { lazyLoadPlayerCharacterTextures } from "../Entity/PlayerTexturesLoadingManager.ts";
import { lazyLoadPlayerCompanionTexture } from "../Companion/CompanionTexturesLoadingManager.ts";
...
import { SelectCharacterScene, SelectCharacterSceneName } from "../Login/SelectCharacterScene.ts";
import { hasMovedEventName, Player, requestEmoteEventName } from "../Player/Player.ts";
import { ErrorSceneName } from "../Reconnecting/ErrorScene.ts";
import { ReconnectingSceneName } from "../Reconnecting/ReconnectingScene.ts";
import { TextUtils } from "../Components/TextUtils.ts";
import { joystickBaseImg, joystickBaseKey, joystickThumbImg, joystickThumbKey } from "../Components/MobileJoystick.ts";
import { PropertyUtils } from "../Map/PropertyUtils.ts";
...
import type { ItemFactoryInterface } from "../Items/ItemFactoryInterface.ts";
...
import { GameSceneUserInputHandler } from "../UserInput/GameSceneUserInputHandler.ts";
...
import { SelectCompanionScene, SelectCompanionSceneName } from "../Login/SelectCompanionScene.ts";
...
import { PlayersPositionInterpolator } from "./PlayersPositionInterpolator.ts";
import { DirtyScene } from "./DirtyScene.ts";
import { StartPositionCalculator } from "./StartPositionCalculator.ts";
import { GameMapPropertiesListener } from "./GameMapPropertiesListener.ts";
import { ActivatablesManager } from "./ActivatablesManager.ts";
import type { AddPlayerInterface } from "./AddPlayerInterface.ts";
import type { CameraManagerEventCameraUpdateData } from "./CameraManager.ts";
import { CameraManager, CameraManagerEvent } from "./CameraManager.ts";
import { EditorToolName, MapEditorModeManager } from "./MapEditor/MapEditorModeManager.ts";
import type { PlayerDetailsUpdate } from "./RemotePlayersRepository.ts";
import { RemotePlayersRepository } from "./RemotePlayersRepository.ts";
import { IframeEventDispatcher } from "./IframeEventDispatcher.ts";
import { PlayerVariablesManager } from "./PlayerVariablesManager.ts";
import { SayManager } from "./Say/SayManager.ts";
import { EntitiesCollectionsManager } from "./MapEditor/EntitiesCollectionsManager.ts";
import { DEPTH_BUBBLE_CHAT_SPRITE, DEPTH_WHITE_MASK } from "./DepthIndexes.ts";
import { ScriptingEventsManager } from "./ScriptingEventsManager.ts";
import { FollowManager } from "./FollowManager.ts";
import { InviteManager } from "./InviteManager.ts";
import { LocateManager } from "./LocateManager.ts";
import { uiWebsiteManager } from "./UI/UIWebsiteManager.ts";
import { ScriptingVideoManager } from "./ScriptingVideoManager.ts";
        ...
        for (const [itemType, objectsOfType] of this.objectsByType) {
            ...
            switch (itemType) {
                case "computer": {
                    ...
                    const module = await import("../Items/Computer/computer.ts");
