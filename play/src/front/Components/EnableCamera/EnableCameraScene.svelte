...
<form class="enableCameraScene pointer-events-auto relative z-30 m-0" on:submit|preventDefault={submit}>
    <section class="flex items-center justify-center min-h-screen ">
        <div class="text-white container mx-auto flex flex-col items-center justify-center">
                    ...
                    <div class="flex items-center justify-center">
                        ...
                        microphoneEdit = false;
                            ...
                            >
                                ...
                                <div class="space-y-1">
                                    <div class="text-lg bold max-w-[241px] truncate text-ellipsis overflow-hidden leading-tight flex items-center">
                ...
                <div class="px-4 pt-4 pb-2 rounded-lg bg-white/10 mt-4 flex flex-col justify-center items-center">
                    ...
                    <div class="flex justify-center">
                        ...
                        cameraEdit = false;
                            ...
                            >
                                {#if selectedCamera == undefined}
                                    <div class="webrtcsetup flex items-center justify-center h-[200px] aspect-video overflow-hidden bg-contrast">
                                        <CamOffIcon />
                                    </div>
                                {/if}
                ...
                {#if $speakerSelectedStore != undefined && $speakerListStore && $speakerListStore.length > 0}
                    ...
                    <div class="px-4 pt-4 pb-2 rounded-lg bg-white/10 mt-4 flex flex-col justify-center items-center">
                        <div class="text-lg bold flex items-center justify-center space-x-3 mb-2 pl-2">
                            ...
                            <button class="btn {!speakerEdit ? 'btn-secondary' : 'btn-light btn-ghost'}"
                                    on:click|stopPropagation|preventDefault={() => (speakerEdit = !speakerEdit)}
                            >
                                {!speakerEdit ? 'Edit speaker' : 'Cancel'} <!-- Trad -->
                            </button>
                        </div>
                            ...
                            <div class="flex flex-wrap items-center justify-center min-h-[129px]">
                                {#each $speakerListStore as speaker(speaker.deviceId)}
                                    ...
                                    >
                                        ...
                                        {#if speaker.deviceId === $speakerSelectedStore}
                                        <button class="btn btn-secondary"> <!-- TODO HUGO -->
                                            <VolumeIcon />
                                        </button>
                                        {/if}
                                    </div>
            ...
            <section class="flex items-center space-x-4 justify-between border border-t border-white pt-8 min-w-[402px]">
                <button type="submit" class="btn btn-light btn-lg btn-ghost min-w-[175px] rounded block">Cancel</button> <!-- Trad & TODO ACTION -->
                <button type="submit" class="btn btn-secondary btn-lg min-w-[175px] rounded block">Valider</button> <!-- Trad & Changer le label qui est pas ouf -->
            </section>
        </div>
    </section>
</form>
