...
{#if $wokaEmoteWheelVisibleStore}
    ...
    <div
        class="fixed inset-0 z-[600] flex items-center justify-center pointer-events-auto"
    ...
    >
        ...
        >
            <div
                class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-center text-white/70 text-xs w-28 select-none"
            >
