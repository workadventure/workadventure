...
<ActionBarButtonWrapper classList="group/btn-layout">
    <ActionBarIconButton
        on:click={() => {
        ...
        dataTestId="changeLayout"
    >
        <!--            tooltipTitle={$LL.actionbar.help.changeLayout.title()}
                    tooltipDesc={$LL.actionbar.help.changeLayout.desc()} -->
