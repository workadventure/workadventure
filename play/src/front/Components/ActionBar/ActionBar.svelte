                ...
                <div class="flex items-center">
                    {#if !$inExternalServiceStore && !$silentStore && $proximityMeetingStore}
                        ...
                        {#if $myMicrophoneStore}
                            ...
                            <div class="absolute p-4 w-60 text-white text-center rounded-lg top-20 left-1/2 transform -translate-x-1/2 before:content-[''] before:absolute before:w-full before:h-full before:z-1 before:bg-secondary before:left-0 before:top-0 before:rounded-lg before:bg-contrast/80 before:backdrop-blur">
