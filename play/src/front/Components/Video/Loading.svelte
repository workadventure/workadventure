<div
    data-id="loading"
    class="bg-contrast/80 rounded-lg w-full h-full p-2 flex justify-center items-center text-white gap-4"
>
    <div class="flex flex-col items-center">
        <div aria-label="Loading..." role="status">
            <svg class="h-6 w-6 animate-spin mr-3" viewBox="3 3 18 18">
                <path
                    class="fill-white"
