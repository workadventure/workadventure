...
<div class="group/screenshare relative video-container rounded-lg {cssClass ? cssClass : ''}" class:hide={!stream} style="height:{$heightCamWrapper}px">
    {#if stream}
        <video
        ...
        />
        <div class="absolute top-0 bottom-0 right-0 left-0 m-auto h-14 w-14 z-20 p-4 rounded-full aspect-ratio bg-contrast/50 backdrop-blur transition-all opacity-0 group-hover/screenshare:opacity-100 pointer-events-none">
