...
<div class="{position} z-30 responsive-dimension ">
    <div class="flex justify-between  rounded bg-transparent">
        <div class="relative  backdrop-blur px-2 py-1 text-white text-sm bold rounded text-nowrap flex flex-col items-center ">
            ...
            <div class="flex items-center"> <span>{name}</span>
                <slot /></div>
        </div>
    </div>
</div>
...
<div class="{position} z-30 responsive-dimension ">
    <div class="flex justify-between  rounded {isPlayingAudio ? 'bg-secondary/90' : 'bg-contrast/90'}">
        <div class="relative backdrop-blur px-2 py-1 text-white text-sm pl-12 bold rounded text-nowrap  flex items-center">
