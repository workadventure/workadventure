<script lang="ts">
    import type { Game } from "../Phaser/Game/Game.ts";
    import { errorStore } from "../Stores/ErrorStore.ts";
    import { errorScreenStore } from "../Stores/ErrorScreenStore.ts";
    import { loginSceneVisibleStore } from "../Stores/LoginSceneStore.ts";
    import { enableCameraSceneVisibilityStore } from "../Stores/MediaStore.ts";
    ...
    import { gameSceneIsLoadedStore } from "../Stores/GameSceneStore.ts";
    import { mapEditorModeStore } from "../Stores/MapEditorStore.ts";
    import { refreshPromptStore } from "../Stores/RefreshPromptStore.ts";
    import { forceRefreshChatStore } from "../Stores/ChatStore.ts";
    import { loaderVisibleStore } from "../Stores/LoaderStore.ts";
    import { showModalGlobalComminucationVisibilityStore } from "../Stores/ModalStore.ts";
    import { isActivatedStore as calendarIsActivatedStore, isCalendarVisibleStore } from "../Stores/CalendarStore.ts";
    import { isActivatedStore as todoListIsActivatedStore, isTodoListVisibleStore } from "../Stores/TodoListStore.ts";
    import { draggingFile } from "../Stores/FileUploadStore.ts";
