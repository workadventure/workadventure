...
<!-- Banner for Follow Menu-->
<!-- {#if $bannerVisible} -->
<div class="fixed bottom-2 left-0 right-0 m-auto bg-contrast/80 backdrop-blur text-white w-[500px] rounded-lg overflow-hidden z-[203] hidden">
  ...
  <div class="flex flex-col items-center p-4 space-x-4 bg-contrast mt-4 pointer-events-auto">
