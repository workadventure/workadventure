...
{#if $followStateStore === "requesting" && $followRoleStore === "follower"}
    <div class="interact-menu text-center text-white sm:w-[500px] sm:h-[250px] -mt-4 absolute left-0 right-0 pointer-events-auto z-[150] right-0 left-0 m-auto rounded-lg overflow-hidden margin-bottom responsive-follow-follower">
