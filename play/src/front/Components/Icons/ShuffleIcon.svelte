...
<svg  xmlns="http://www.w3.org/2000/svg"
      class="icon {height} {width} {strokeColor} {fillColor} {classList} icon icon-tabler icons-tabler-outline icon-tabler-arrows-shuffle"
      viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor"
...
>
    ...
    <path d="M18 20l3 -3l-3 -3" /><path d="M3 7h3a5 5 0 0 1 5 5a5 5 0 0 0 5 5h5" />
