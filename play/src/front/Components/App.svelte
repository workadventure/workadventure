<script lang="ts">
    ...
    import { DEBUG_MODE, SENTRY_DSN_FRONT, SENTRY_ENVIRONMENT, SENTRY_RELEASE } from "../Enum/EnvironmentVariable.ts";
    import { HdpiManager } from "../Phaser/Services/HdpiManager.ts";
    import { EntryScene } from "../Phaser/Login/EntryScene.ts";
    import { LoginScene } from "../Phaser/Login/LoginScene.ts";
    import { SelectCharacterScene } from "../Phaser/Login/SelectCharacterScene.ts";
    import { SelectCompanionScene } from "../Phaser/Login/SelectCompanionScene.ts";
    import { EnableCameraScene } from "../Phaser/Login/EnableCameraScene.ts";
    import { ReconnectingScene } from "../Phaser/Reconnecting/ReconnectingScene.ts";
    import { ErrorScene } from "../Phaser/Reconnecting/ErrorScene.ts";
    import { Game } from "../Phaser/Game/Game.ts";
    import { waScaleManager } from "../Phaser/Services/WaScaleManager.ts";
    import { HtmlUtils } from "../WebRtc/HtmlUtils.ts";
    import { iframeListener } from "../Api/IframeListener.ts";
    import { desktopApi } from "../Api/Desktop/index.ts";
    import { canvasSize, coWebsiteManager, coWebsites, fullScreenCowebsite } from "../Stores/CoWebsiteStore.ts";
    import { urlManager } from "../Url/UrlManager.ts";
    import { FileListener } from "../Phaser/FileUpload/FileListener.ts";
    import { isStructuredCloneSupported } from "../Utils/BrowserCompatibility.ts";
