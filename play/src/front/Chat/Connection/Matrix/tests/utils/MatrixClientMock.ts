...
> => ({
    ...
    getStoredCrossSigningForUser: vi.fn(),
    getKeyBackupVersion: vi.fn().mockResolvedValue(null),
    secretStorage: { hasKey: vi.fn() },
...
export const matrixClientMock: Partial<MatrixClient> = {
    createRoom: vi.fn(),
    getUsers: vi.fn(),
    getRooms: vi.fn(),
    once: vi.fn(),
