...
<div class="tw-flex tw-flex-col tw-w-full tw-gap-2">
    {#if loadingFetchServer}
        <div class="tw-flex tw-flex-col tw-gap-2 tw-p-6 tw-rounded-xl tw-z-50 tw-w-full tw-justify-center tw-items-center">
            <div class="tw-loader tw-w-6 tw-h-6 tw-border-2 tw-border-t-[2px] tw-border-primary tw-rounded-full tw-animate-spin"
    ...
    {#if !bridgeConnected}
        <div class="tw-py-8 tw-px-3">
            <p class=" tw-text-sm tw-text-gray-500">
                You need to connect your Discord account to use this feature. 
                To do so, please click on the button below. You will be redirected to Discord to login. 
                To get all Discord servers, the bot need to be connected to your account. 
                And finally, you will be able to choose which servers you want to bridge.
            </p>
        </div>
    ...
    {#if bridgeConnected && servers.length > 0}
        <button class="tw-w-full tw-p-2 tw-bg-secondary-800  tw-text-white tw-no-underline tw-rounded-md tw-text-center tw-justify-center tw-cursor-pointer hover:tw-no-underline hover:tw-text-white tw-flex tw-flex-row tw-items-center"
