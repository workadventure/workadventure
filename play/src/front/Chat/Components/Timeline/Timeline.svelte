...
<div id="timeline" class="tw-min-h-full tw-border-b tw-border-solid tw-border-0 tw-border-transparent tw-border-b-light-purple">
        ...
        <div class="wa-chat-item">
            ...
            <div class="tw-flex-auto tw-ml-2" on:click|stopPropagation={open}>
                <h1 class="tw-text-sm tw-font-bold tw-mb-0">
                    <span>{$LL.chat.timeLine.title()}</span>
                </h1>
                <div class="tw-text-xs tw-text-lighter-purple tw-mt-0">
                    {$LL.chat.timeLine.open()}
                </div>
            </div>
            {#if unreadMessages}
                <span
