...
{#if $selectedRoom === undefined || displayTwoColumnLayout}
    <div class="tw-w-full tw-max-w-xs" style={displayTwoColumnLayout ? "border-right:1px solid grey;padding-right:12px" : ""}>
...
{:else if $selectedRoom === undefined && displayTwoColumnLayout}
