...
import { isStartWritingEvent, isStopWritingEvent } from "@workadventure/shared-utils/src/Events/WritingEvent.js";
import { isUpdateWritingStatusChatListEvent } from "@workadventure/shared-utils/src/Events/UpdateWritingStatusChatListEvent.js";
import { isClosePopupEvent } from "./ClosePopupEvent.ts";
import { isGoToPageEvent } from "./GoToPageEvent.ts";
import { isLoadPageEvent } from "./LoadPageEvent.ts";
import { isCoWebsite, isOpenCoWebsiteEvent } from "./OpenCoWebsiteEvent.ts";
import { isOpenPopupEvent } from "./OpenPopupEvent.ts";
import { isOpenTabEvent } from "./OpenTabEvent.ts";
import { isLayerEvent } from "./LayerEvent.ts";
import { isSetPropertyEvent } from "./SetPropertyEvent.ts";
import { isLoadSoundEvent } from "./LoadSoundEvent.ts";
import { isPlaySoundEvent } from "./PlaySoundEvent.ts";
import { isStopSoundEvent } from "./StopSoundEvent.ts";
import { isSetTilesEvent } from "./SetTilesEvent.ts";
import { isGameStateEvent } from "./GameStateEvent.ts";
import { isMapDataEvent } from "./MapDataEvent.ts";
import { isSetVariableEvent } from "./SetVariableEvent.ts";
import { isCreateEmbeddedWebsiteEvent, isEmbeddedWebsiteEvent } from "./EmbeddedWebsiteEvent.ts";
import { isLoadTilesetEvent } from "./LoadTilesetEvent.ts";
import { isMessageReferenceEvent, isTriggerActionMessageEvent } from "./Ui/TriggerActionMessageEvent.ts";
import { isMenuRegisterEvent, isOpenMenuEvent, isUnregisterMenuEvent } from "./Ui/MenuEvents.ts";
import { isPlayerPosition } from "./PlayerPosition.ts";
import { isCameraSetEvent } from "./CameraSetEvent.ts";
import { isCameraFollowPlayerEvent } from "./CameraFollowPlayerEvent.ts";
import { isColorEvent } from "./ColorEvent.ts";
import { isMovePlayerToEventConfig } from "./MovePlayerToEvent.ts";
import { isMovePlayerToEventAnswer } from "./MovePlayerToEventAnswer.ts";
import { isAddActionsMenuKeyToRemotePlayerEvent } from "./AddActionsMenuKeyToRemotePlayerEvent.ts";
import { isRemoveActionsMenuKeyFromRemotePlayerEvent } from "./RemoveActionsMenuKeyFromRemotePlayerEvent.ts";
import { isSetAreaPropertyEvent } from "./SetAreaPropertyEvent.ts";
import { isCreateUIWebsiteEvent, isModifyUIWebsiteEvent, isUIWebsiteEvent } from "./Ui/UIWebsiteEvent.ts";
import { isCreateDynamicAreaEvent, isDynamicAreaEvent } from "./CreateDynamicAreaEvent.ts";
import { isUserInputChatEvent } from "./UserInputChatEvent.ts";
import { isEnterLeaveEvent } from "./EnterLeaveEvent.ts";
import { isChangeLayerEvent } from "./ChangeLayerEvent.ts";
import { isChangeAreaEvent } from "./ChangeAreaEvent.ts";
import { isButtonClickedEvent } from "./ButtonClickedEvent.ts";
import { isActionsMenuActionClickedEvent } from "./ActionsMenuActionClickedEvent.ts";
import { isHasPlayerMovedEvent } from "./HasPlayerMovedEvent.ts";
import { isWasCameraUpdatedEvent } from "./WasCameraUpdatedEvent.ts";

import { isLeaveMucEvent } from "./LeaveMucEvent.ts";
import { isJoinMucEvent } from "./JoinMucEvent.ts";
import { isMenuItemClickedEvent } from "./Ui/MenuItemClickedEvent.ts";
import { isJoinProximityMeetingEvent } from "./ProximityMeeting/JoinProximityMeetingEvent.ts";
import { isParticipantProximityMeetingEvent } from "./ProximityMeeting/ParticipantProximityMeetingEvent.ts";
import { isSetSharedPlayerVariableEvent } from "./SetSharedPlayerVariableEvent.ts";
import { isEnablePlayersTrackingEvent } from "./EnablePlayersTrackingEvent.ts";
import { isAddPlayerEvent, isRemotePlayerChangedEvent } from "./AddPlayerEvent.ts";
import { isSetPlayerVariableEvent } from "./SetPlayerVariableEvent.ts";
import { isSettingsEvent } from "./SettingsEvent.ts";
import { isChatVisibilityEvent } from "./ChatVisibilityEvent.ts";
import { isShowBusinessCardEvent } from "./ShowBusinessCardEvent.ts";
import { isModalEvent } from "./ModalEvent.ts";
import { isAddActionBarButtonEvent, isRemoveButtonActionBarEvent } from "./Ui/ButtonActionBarEvent.ts";
import { isBannerEvent } from "./Ui/BannerEvent.ts";
import { isTeleportPlayerToEventConfig } from "./TeleportPlayerToEvent.ts";
import { isSendEventEvent } from "./SendEventEvent.ts";
import { isReceiveEventEvent } from "./ReceiveEventEvent.ts";
import { isPlaySoundInBubbleEvent } from "./ProximityMeeting/PlaySoundInBubbleEvent.ts";
import { isStartStreamInBubbleEvent } from "./ProximityMeeting/StartStreamInBubbleEvent.ts";
import { isAppendPCMDataEvent } from "./ProximityMeeting/AppendPCMDataEvent.ts";
import { isWamMapDataEvent } from "./WamMapDataEvent.ts";
import { isPlayVideoEvent } from "./Ui/PlayVideoEvent.ts";
