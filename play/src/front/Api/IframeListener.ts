...
import { KLAXOON_ACTIVITY_PICKER_EVENT, ChatMessage, BanEvent ,ChatMessageTypes } from "@workadventure/shared-utils";
...
class IframeListener {
    ...
    private  unsubscribeNewChatMessageSubject  : Subscription|null = null
    ...
    init() {
        window.addEventListener(
         ...
         this.unsubscribeNewChatMessageSubject = newChatMessageSubject.subscribe((message) => {
    ...
    cleanup() {
        ...
        this.unsubscribeNewChatMessageSubject?.unsubscribe();
    }
