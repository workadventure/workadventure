...
export const hasEmbedScreen = derived([streamableCollectionStore, coWebsites], ([$streamableCollectionStore, $coWebsites]) => ($streamableCollectionStore.size + $coWebsites.length) > 0);
