...
const actionbar: DeepPartial<Translation["actionbar"]> = {
    ...
    desktop: {
        section: "Desktop-app",
        changeWorld: "Van wereld wisselen",
        title: "Een andere wereld openen",
        description: "Plak de volledige URL van de WorkAdventure-wereld die je wilt openen.",
        urlLabel: "Wereld-URL",
        urlPlaceholder: "https://play.workadventu.re/@/...",
        urlRequired: "Voer de URL van een wereld in.",
        unavailable: "Navigeren tussen werelden is alleen beschikbaar in de desktop-app.",
        openFailed: "Deze wereld kon niet worden geopend.",
        openAction: "Wereld openen",
        opening: "Openen...",
        createTitle: "Een nieuwe wereld nodig?",
        createDescription: "Maak en configureer een nieuwe ruimte vanuit de WorkAdventure-beheerconsole.",
        createAction: "Mijn wereld maken",
        openingSignup: "Registratie openen...",
        signupFailed: "De registratiepagina kon niet worden geopend.",
    },
