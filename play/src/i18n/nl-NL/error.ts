...
const error: BaseTranslation = {
    accessLink: {
        ...
        details: "Als je meer informatie wilt, kun je contact opnemen met de beheerder of ons bereiken via: hello@workadventu.re",
    },
    connectionRejected: {
    ...
    errorDialog: {
        title: "Fout 😱",
        hasReportIssuesUrl: "Als je meer informatie wilt, kun je contact opnemen met de beheerder of een probleem melden via:",
