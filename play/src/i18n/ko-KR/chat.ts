...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    roomPanel: {
        ...
        settings: {
            ...
            joinRule: "접근 권한",
            restrictedTo: "제한 대상",
            restrictedUnavailable: "이 룸은 폴더 또는 스페이스에 연결되어 있지 않습니다.",
            readOnly: "여기서는 이 설정을 읽기 전용으로만 볼 수 있습니다.",
            unknown: "알 수 없음",
            save: "저장",
            saving: "저장 중...",
            ...
            errors: {
                roomNameEmpty: "룸 이름은 비워 둘 수 없습니다",
                restrictedAccessNeedsParentSpace: "제한된 접근에는 연결된 폴더 또는 스페이스가 필요합니다.",
            },
            joinRules: {
                public: "공개",
                invite: "초대만",
            ...
            permissions: {
                ...
                sendReactions: "반응 보내기",
                redactOwnMessages: "내 메시지 삭제",
                redactOtherMessages: "다른 사람의 메시지 삭제",
                kickUsers: "사용자 내보내기",
                banUsers: "사용자 차단",
                inviteUsers: "사용자 초대",
                changeSettings: "설정 변경",
                changeRoomName: "룸 이름 변경",
                changeRoomTopic: "룸 주제 변경",
                changeHistoryVisibility: "기록 공개 범위 변경",
