...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    chooseDeviceVerificationMethodModal: {
        ...
        withQrCode: "스캔할 QR 코드 표시",
        withPassphrase: "보안 암호로 확인",
    },
    verificationQrCodeDialog: {
        title: "QR 코드로 인증",
        preparing: "QR 코드를 준비하는 중…",
        scanInstruction: "다른 기기(예: Element 모바일 앱)로 이 QR 코드를 스캔하세요.",
        reciprocateQuestion: "다른 기기에서 코드를 스캔하고 녹색 방패가 표시되었나요?",
        reciprocateYes: "예",
        reciprocateNo: "아니오",
        cancel: "취소",
        success: "기기가 인증되었습니다.",
        cancelled: "인증이 취소되었습니다.",
        unsupported: "다른 기기에서 QR 코드를 스캔할 수 없습니다. 대신 이모지로 인증해 보세요.",
