...
const actionbar: DeepPartial<Translation["actionbar"]> = {
    ...
    desktop: {
        ...
        changeWorld: "월드 변경",
        title: "다른 월드 열기",
        description: "열려는 WorkAdventure 월드의 전체 URL을 붙여넣으세요.",
        urlLabel: "월드 URL",
        urlPlaceholder: "https://play.workadventu.re/@/...",
        urlRequired: "월드 URL을 입력하세요.",
        unavailable: "월드 탐색은 데스크톱 앱에서만 사용할 수 있습니다.",
        openFailed: "이 월드를 열 수 없습니다.",
        openAction: "월드 열기",
        opening: "여는 중...",
        createTitle: "새 월드가 필요하신가요?",
        createDescription: "WorkAdventure 관리 콘솔에서 새 공간을 만들고 설정하세요.",
        createAction: "내 월드 만들기",
        openingSignup: "가입 페이지 여는 중...",
        signupFailed: "가입 페이지를 열 수 없습니다.",
    },
