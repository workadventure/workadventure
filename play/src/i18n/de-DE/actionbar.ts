...
const actionbar: DeepPartial<Translation["actionbar"]> = {
    ...
    desktop: {
        ...
        title: "Eine andere Welt öffnen",
        description: "Fügen Sie die vollständige URL der WorkAdventure-Welt ein, die Sie öffnen möchten.",
        urlLabel: "Welt-URL",
        urlPlaceholder: "https://play.workadventu.re/@/...",
        urlRequired: "Bitte geben Sie die URL einer Welt ein.",
        unavailable: "Die Weltnavigation ist nur in der Desktop-App verfügbar.",
        openFailed: "Diese Welt konnte nicht geöffnet werden.",
        openAction: "Welt öffnen",
        opening: "Wird geöffnet...",
        createTitle: "Benötigen Sie eine neue Welt?",
        createDescription: "Erstellen und konfigurieren Sie einen neuen Raum in der WorkAdventure-Verwaltung.",
        createAction: "Meine Welt erstellen",
        openingSignup: "Registrierung wird geöffnet...",
        signupFailed: "Die Registrierungsseite konnte nicht geöffnet werden.",
    },
