...
const actionbar: DeepPartial<Translation["actionbar"]> = {
    ...
    desktop: {
        ...
        changeWorld: "Changer de world",
        title: "Ouvrir un autre world",
        description: "Collez l’URL complète du world WorkAdventure que vous souhaitez ouvrir.",
        urlLabel: "URL du world",
        urlPlaceholder: "https://play.workadventu.re/@/...",
        urlRequired: "Veuillez saisir l’URL d’un world.",
        unavailable: "Le changement de world est disponible uniquement dans l’application desktop.",
        openFailed: "Impossible d’ouvrir ce world.",
        openAction: "Ouvrir le world",
        opening: "Ouverture...",
        createTitle: "Besoin d’un nouveau world ?",
        createDescription: "Créez et configurez un nouvel espace depuis l’administration WorkAdventure.",
        createAction: "Créer mon world",
        openingSignup: "Ouverture de l’inscription...",
        signupFailed: "Impossible d’ouvrir la page d’inscription.",
    },
