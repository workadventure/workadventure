...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    poll: {
        ...
        create: {
            ...
            removeAnswer: "Supprimer la réponse {index}",
    ...
    showFullMessage: "Voir plus",
    showLessMessage: "Voir moins",
    ...
    roomPanel: {
        ...
        settings: {
            ...
            restrictedUnavailable: "Ce salon n'est pas lié à un dossier ou à un espace.",
            ...
            errors: {
                roomNameEmpty: "Le nom du salon ne peut pas être vide",
                restrictedAccessNeedsParentSpace: "L'accès restreint nécessite un dossier ou un espace lié.",
            },
            joinRules: {
                public: "Public",
            ...
            permissions: {
                ...
                redactOwnMessages: "Supprimer ses propres messages",
                redactOtherMessages: "Supprimer les messages des autres",
                kickUsers: "Expulser des utilisateurs",
                banUsers: "Bannir des utilisateurs",
                inviteUsers: "Inviter des utilisateurs",
                changeSettings: "Changer les paramètres",
                changeRoomName: "Changer le nom du salon",
                changeRoomTopic: "Changer le sujet du salon",
                changeHistoryVisibility: "Changer la visibilité de l'historique",
                changeAccess: "Changer l'accès",
                changePermissions: "Changer les autorisations",
            },
        },
    ...
    partiallyFailedToSendMessage:
        "Une partie du message a été envoyée. Le texte non envoyé a été conservé dans le champ de saisie.",
