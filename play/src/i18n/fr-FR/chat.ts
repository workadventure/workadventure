...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    noMessage: "Aucun message envoyé",
    ...
    timeLine: {
        ...
        sessionSummary: "Session avec {count} participant(s)",
        sessionInProgress: "En cours",
        sessionViewHistory: "Voir l'historique",
        sessionStartedAt: "Démarrée à {date}",
        sessionEndedAt: "Terminée à {date}",
