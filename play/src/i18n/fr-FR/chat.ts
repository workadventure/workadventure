...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    chooseDeviceVerificationMethodModal: {
        ...
        withQrCode: "Afficher un QR code à scanner",
        withPassphrase: "Vérifier avec la phrase de sécurité",
    },
    verificationQrCodeDialog: {
        title: "Vérifier par QR code",
        preparing: "Préparation du QR code…",
        scanInstruction: "Scannez ce QR code avec votre autre appareil (par exemple l'application Element mobile).",
        reciprocateQuestion: "Votre autre appareil a-t-il scanné le code et affiché un bouclier vert ?",
        reciprocateYes: "Oui",
        reciprocateNo: "Non",
        cancel: "Annuler",
        success: "Votre appareil est maintenant vérifié.",
        cancelled: "La vérification a été annulée.",
        unsupported: "Votre autre appareil ne peut pas scanner de QR code. Essayez plutôt la vérification par emojis.",
        error: "Le QR code n'a pas pu être généré.",
    },
