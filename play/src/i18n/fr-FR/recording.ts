...
const recording: DeepPartial<Translation["recording"]> = {
    ...
    notification: {
        ...
        startFailedNotification: "Échec du démarrage de l'enregistrement",
        stopFailedNotification: "Échec de l'arrêt de l'enregistrement",
        ...
        unexpectedlyStoppedNotification: "L'enregistrement s'est arrêté de manière inattendue",
