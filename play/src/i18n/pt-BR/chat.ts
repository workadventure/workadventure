...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    notification: {
        ...
        file: "enviou um arquivo: {fileName}",
        forum: "no fórum",
        in: "em",
    },
    see: "Ver",
    ...
    poll: {
        ...
        create: {
            ...
            removeAnswer: "Remover resposta {index}",
    ...
    roomPanel: {
        ...
        settings: {
            ...
            restrictedUnavailable: "Esta sala não está vinculada a uma pasta ou espaço.",
            ...
            errors: {
                roomNameEmpty: "O nome da sala não pode ficar vazio",
                restrictedAccessNeedsParentSpace: "O acesso restrito requer uma pasta ou um espaço vinculado.",
            },
            joinRules: {
                public: "Pública",
            ...
            permissions: {
                ...
                redactOwnMessages: "Excluir próprias mensagens",
                redactOtherMessages: "Excluir mensagens de outras pessoas",
                kickUsers: "Expulsar usuários",
                banUsers: "Banir usuários",
                inviteUsers: "Convidar usuários",
                changeSettings: "Alterar configurações",
                changeRoomName: "Alterar nome da sala",
                changeRoomTopic: "Alterar tópico da sala",
                changeHistoryVisibility: "Alterar visibilidade do histórico",
