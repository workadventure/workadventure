...
const actionbar: BaseTranslation = {
    ...
    desktop: {
        section: "Aplicativo desktop",
        changeWorld: "Mudar de mundo",
        title: "Abrir outro mundo",
        description: "Cole a URL completa do mundo WorkAdventure que você deseja abrir.",
        urlLabel: "URL do mundo",
        urlPlaceholder: "https://play.workadventu.re/@/...",
        urlRequired: "Insira a URL de um mundo.",
        unavailable: "A navegação entre mundos está disponível apenas no aplicativo desktop.",
        openFailed: "Não foi possível abrir este mundo.",
        openAction: "Abrir mundo",
        opening: "Abrindo...",
        createTitle: "Precisa de um novo mundo?",
        createDescription: "Crie e configure um novo espaço pelo console de administração do WorkAdventure.",
        createAction: "Criar meu mundo",
        openingSignup: "Abrindo cadastro...",
        signupFailed: "Não foi possível abrir a página de cadastro.",
    },
