...
const mapEditor: BaseTranslation = {
    ...
    properties: {
        ...
        personalAreaConfiguration: {
            ...
            dynamicAccessDescription: "Qualquer um com tags de usuário apropriadas pode reivindicar a propriedade da zona.",
        ...
        excalidrawProperties: {
            ...
            description: "Um quadro branco virtual de código aberto com estilo desenhado à mão. Colaborativo e criptografado de ponta a ponta.",
    ...
    settings: {
        ...
        room: {
            ...
            helps: {
                description: "Uma descrição do mapa. Pode ser usada em redes sociais ao compartilhar um link para o mapa.",
