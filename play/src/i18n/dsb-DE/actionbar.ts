...
const actionbar: DeepPartial<Translation["actionbar"]> = {
    ...
    desktop: {
        section: "Desktopowe nałoženje",
        changeWorld: "Swět změniś",
        title: "Drugi swět wócyniś",
        description: "Zasajźćo dopołny URL WorkAdventure-swěta, kótaryž cośo wócyniś.",
        urlLabel: "URL swěta",
        urlPlaceholder: "https://play.workadventu.re/@/...",
        urlRequired: "Pšosym zapódajśo URL swěta.",
        unavailable: "Navigacija pó swětach jo jano w desktopowem nałoženju k dispoziciji.",
        openFailed: "Toś ten swět njedajo se wócyniś.",
        openAction: "Swět wócyniś",
        opening: "Wótcynja se...",
        createTitle: "Trjebaśo nowy swět?",
        createDescription: "Napórajśo a konfigurěrujśo nowu rum w administraciji WorkAdventure.",
        createAction: "Mój swět napóraś",
        openingSignup: "Registracija se wócynja...",
        signupFailed: "Bok registracije njedajo se wócyniś.",
    },
