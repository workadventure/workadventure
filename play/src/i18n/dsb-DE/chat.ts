...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    roomPanel: {
        ...
        home: {
            directRoom: "Direktny rum",
            groupRoom: "Kupkowy rum",
            encrypted: "Zaklucowany",
            notEncrypted: "Njezaklucowany",
            readOnly: "Jano za cytanje",
        },
        settings: {
            roomType: "Typ ruma",
            encryption: "Zaklucowanje",
            topic: "Tema",
            joinRule: "Pśistup",
            restrictedTo: "Wobgranicowany na",
            restrictedUnavailable: "Toś ten rum njejo z zarědnikom abo rumom zwězany.",
            readOnly: "Toś te nastajenja su how jano za cytanje.",
            unknown: "Njeznaty",
            save: "Składowaś",
            saving: "Składujo se...",
            saveSuccess: "Nastajenja skłaźone",
            saveError: "Nastajenja njedaju se składowaś",
            errors: {
                roomNameEmpty: "Mě ruma njesmějo prozne byś",
                restrictedAccessNeedsParentSpace: "Wobgranicowany pśistup trjeba zwězany zarědnik abo rum.",
            },
            joinRules: {
                public: "Zjawny",
                invite: "Jano z pśepšosynim",
                restricted: "Wobgranicowany",
                knock: "Pśistup pominaś",
            },
            permissions: {
                title: "Pšawa",
                sendMessages: "Powěsći pósłaś",
                sendReactions: "Reakcije pósłaś",
                redactOwnMessages: "Swójske powěsći wulašowaś",
                redactOtherMessages: "Powěsći drugich wulašowaś",
                kickUsers: "Wužywarjow wótpokazaś",
                banUsers: "Wužywarjow zastajiś",
                inviteUsers: "Wužywarjow pśepšosyś",
                changeSettings: "Nastajenja změniś",
                changeRoomName: "Mě ruma změniś",
                changeRoomTopic: "Temu ruma změniś",
                changeHistoryVisibility: "Widobnosć historije změniś",
                changeAccess: "Pśistup změniś",
                changePermissions: "Pšawa změniś",
            },
        },
