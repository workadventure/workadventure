...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    noMessage: "Žedna powěsć pósłana",
    ...
    timeLine: {
        ...
        sessionSummary: "Sesija z {count} wobźělnikami",
        sessionInProgress: "Běžy",
        sessionViewHistory: "Historiju pokazaś",
        sessionStartedAt: "Zachopjena: {date}",
        sessionEndedAt: "Skóńcona: {date}",
        sessionDuration: "{minutes} min",
        sessionDurationHours: "{hours}h {minutes}min",
        sessionParticipants: "Wobźělnicy",
        sessionParticipantsCount: "Wobźělnicy ({count})",
        today: "Źinsa",
        yesterday: "Wčera",
    },
    form: {
