...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    chooseDeviceVerificationMethodModal: {
        ...
        withQrCode: "QR kod za skannowanje pokazaś",
        withPassphrase: "Z wěstotneju frazu pśeglědaś",
    },
    verificationQrCodeDialog: {
        title: "Z QR kodom pśeglědaś",
        preparing: "QR kod se pśigótujo…",
        scanInstruction: "Skannuj toś ten QR kod ze swójim drugim rědom (na pśikład z mobilneju Element-aplikaciju).",
        reciprocateQuestion: "Jo twój drugi rěd kod skannował a zeleny šćit pokazał?",
        reciprocateYes: "Jo",
        reciprocateNo: "Ně",
        cancel: "Pśetergnuś",
        success: "Twój rěd jo něnto pśeglědany.",
        cancelled: "Pśeglědanje jo se pśetergnuło.",
        unsupported: "Twój drugi rěd njamóžo QR kod skannowaś. Wopytaj město togo z emojis pśeglědaś.",
        error: "QR kod njedajo se generěrowaś.",
    },
