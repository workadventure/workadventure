    ...
    settings: {
        ...
        megaphone: {
            ...
            inputs: {
                ...
                audienceVideoFeedbackActivated: "Mode auditorium",
                audienceVideoFeedbackActivatedDisabled: "Mode auditorium",
        ...
        recording: {
            ...
            inputs: {
                ...
                enableSounds: "Reproducir una notificación sonora al iniciar y detener la grabación",
                enableSoundsHelper:
                    "Cuando está activado, todos los participantes escucharán una notificación de sonido cuando comience o se detenga una grabación.",
                error: {
                    save: {
