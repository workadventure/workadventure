...
const actionbar: DeepPartial<Translation["actionbar"]> = {
    ...
    desktop: {
        ...
        title: "Abrir otro mundo",
        description: "Pega la URL completa del mundo de WorkAdventure que quieres abrir.",
        urlLabel: "URL del mundo",
        urlPlaceholder: "https://play.workadventu.re/@/...",
        urlRequired: "Introduce la URL de un mundo.",
        unavailable: "La navegación entre mundos solo está disponible en la aplicación de escritorio.",
        openFailed: "No se ha podido abrir este mundo.",
        openAction: "Abrir mundo",
        opening: "Abriendo...",
        createTitle: "¿Necesitas un mundo nuevo?",
        createDescription: "Crea y configura un espacio nuevo desde la consola de administración de WorkAdventure.",
        createAction: "Crear mi mundo",
        openingSignup: "Abriendo el registro...",
        signupFailed: "No se ha podido abrir la página de registro.",
    },
