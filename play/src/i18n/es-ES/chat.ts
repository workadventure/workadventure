...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    notification: {
        ...
        file: "ha enviado un archivo: {fileName}",
        forum: "en el foro",
        in: "en",
    },
    see: "Ver",
    ...
    poll: {
        ...
        create: {
            ...
            removeAnswer: "Eliminar respuesta {index}",
    ...
    roomPanel: {
        ...
        settings: {
            ...
            restrictedUnavailable: "Esta sala no está vinculada a una carpeta o espacio.",
            readOnly: "Estos ajustes son de solo lectura aquí.",
            unknown: "Desconocido",
            save: "Guardar",
            saving: "Guardando...",
            ...
            errors: {
                roomNameEmpty: "El nombre de la sala no puede estar vacío",
                restrictedAccessNeedsParentSpace: "El acceso restringido requiere una carpeta o espacio vinculado.",
            },
            joinRules: {
                public: "Pública",
            ...
            permissions: {
                ...
                redactOwnMessages: "Eliminar mensajes propios",
                redactOtherMessages: "Eliminar mensajes de otras personas",
                kickUsers: "Expulsar usuarios",
                banUsers: "Bloquear usuarios",
                inviteUsers: "Invitar usuarios",
                changeSettings: "Cambiar ajustes",
                changeRoomName: "Cambiar nombre de la sala",
                changeRoomTopic: "Cambiar tema de la sala",
                changeHistoryVisibility: "Cambiar visibilidad del historial",
