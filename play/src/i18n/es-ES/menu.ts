...
const menu: DeepPartial<Translation["menu"]> = {
    ...
    settings: {
        ...
        microphone: {
            ...
            autoGainControlDescription: "Ajusta automáticamente el volumen del micrófono.",
    ...
    shortcuts: {
        ...
        pushToTalk: "Mantén pulsado para activar temporalmente el micrófono en una reunión",
        follow: "Seguir",
