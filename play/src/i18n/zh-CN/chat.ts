...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    roomPanel: {
        ...
        settings: {
            ...
            joinRule: "访问权限",
            restrictedTo: "限制到",
            restrictedUnavailable: "此房间未关联到文件夹或空间。",
            readOnly: "这些设置在此处为只读。",
            unknown: "未知",
            save: "保存",
            saving: "正在保存...",
            ...
            saveError: "无法保存设置",
            errors: {
                roomNameEmpty: "房间名称不能为空",
                restrictedAccessNeedsParentSpace: "受限访问需要关联的文件夹或空间。",
            },
            joinRules: {
                public: "公开",
                invite: "仅邀请",
            ...
            permissions: {
                title: "权限",
                sendMessages: "发送消息",
                sendReactions: "发送表情回应",
                redactOwnMessages: "删除自己的消息",
                redactOtherMessages: "删除他人的消息",
                kickUsers: "踢出用户",
                banUsers: "封禁用户",
                inviteUsers: "邀请用户",
                changeSettings: "更改设置",
                changeRoomName: "更改房间名称",
                changeRoomTopic: "更改房间主题",
                changeHistoryVisibility: "更改历史可见性",
                changeAccess: "更改访问权限",
