...
const camera: DeepPartial<Translation["camera"]> = {
    ...
    help: {
        ...
        allowCameraMicrophone: "允许网络摄像头和麦克风",
        continue: "不使用摄像头继续游戏",
        continueWithoutMicrophone: "不使用麦克风继续游戏",
        continueCameraMicrophone: "不使用网络摄像头和麦克风继续游戏",
        screen: {
            firefox: "/resources/help-setting-camera-permission/en-US-firefox.png",
            chrome: "/resources/help-setting-camera-permission/en-US-firefox.png",
        },
        tooltip: {
            permissionDeniedTitle: "摄像头访问被阻止",
        ...
        microphoneTooltip: {
            permissionDeniedTitle: "麦克风访问被阻止",
            permissionDeniedDesc:
    ...
    webrtc: {
        ...
        refresh: "刷新",
        continue: "继续",
        newDeviceDetected: "检测到新设备 {device} 🎉 切换？[X] 忽略 [Esc]",
    },
    my: {
        silentZone: "安静区",
