...
const actionbar: DeepPartial<Translation["actionbar"]> = {
    ...
    desktop: {
        ...
        changeWorld: "切换世界",
        title: "打开另一个世界",
        description: "粘贴您想打开的 WorkAdventure 世界的完整 URL。",
        urlLabel: "世界 URL",
        urlPlaceholder: "https://play.workadventu.re/@/...",
        urlRequired: "请输入世界 URL。",
        unavailable: "世界导航仅在桌面应用中可用。",
        openFailed: "无法打开此世界。",
        openAction: "打开世界",
        opening: "正在打开...",
        createTitle: "需要新世界？",
        createDescription: "通过 WorkAdventure 管理控制台创建并配置新空间。",
        createAction: "创建我的世界",
        openingSignup: "正在打开注册页面...",
        signupFailed: "无法打开注册页面。",
    },
