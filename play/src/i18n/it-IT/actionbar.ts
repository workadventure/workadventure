...
const actionbar: DeepPartial<Translation["actionbar"]> = {
    ...
    desktop: {
        ...
        title: "Apri un altro mondo",
        description: "Incolla l'URL completo del mondo WorkAdventure che vuoi aprire.",
        urlLabel: "URL del mondo",
        urlPlaceholder: "https://play.workadventu.re/@/...",
        urlRequired: "Inserisci l'URL di un mondo.",
        unavailable: "La navigazione tra i mondi è disponibile solo nell'app desktop.",
        openFailed: "Non è stato possibile aprire questo mondo.",
        openAction: "Apri mondo",
        opening: "Apertura...",
        createTitle: "Ti serve un nuovo mondo?",
        createDescription: "Crea e configura un nuovo spazio dalla console di amministrazione di WorkAdventure.",
        createAction: "Crea il mio mondo",
        openingSignup: "Apertura della registrazione...",
        signupFailed: "Non è stato possibile aprire la pagina di registrazione.",
    },
