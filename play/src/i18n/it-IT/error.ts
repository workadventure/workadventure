...
const error: BaseTranslation = {
    accessLink: {
        ...
        details: "Se desideri maggiori informazioni, puoi contattare l'amministratore o contattarci a: hello@workadventu.re",
    },
    connectionRejected: {
    ...
    errorDialog: {
        title: "Errore 😱",
        hasReportIssuesUrl: "Se desideri maggiori informazioni, puoi contattare l'amministratore o segnalare un problema a:",
