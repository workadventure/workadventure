...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    chooseDeviceVerificationMethodModal: {
        ...
        withQrCode: "Mostra un codice QR da scansionare",
        withPassphrase: "Verifica con la passphrase di sicurezza",
    },
    verificationQrCodeDialog: {
        title: "Verifica con codice QR",
        preparing: "Preparazione del codice QR…",
        scanInstruction: "Scansiona questo codice QR con l'altro dispositivo (ad esempio l'app mobile Element).",
        reciprocateQuestion: "L'altro dispositivo ha scansionato il codice e mostrato uno scudo verde?",
        reciprocateYes: "Sì",
        reciprocateNo: "No",
        cancel: "Annulla",
        success: "Il tuo dispositivo è ora verificato.",
        cancelled: "La verifica è stata annullata.",
        unsupported: "L'altro dispositivo non può scansionare un codice QR. Prova invece a verificare con gli emoji.",
