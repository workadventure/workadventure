...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    noMessage: "Nessun messaggio inviato",
    ...
    timeLine: {
        ...
        sessionSummary: "Sessione con {count} partecipante/i",
        sessionInProgress: "In corso",
        sessionViewHistory: "Visualizza cronologia",
        sessionStartedAt: "Iniziata alle {date}",
        sessionEndedAt: "Terminata alle {date}",
        sessionDuration: "{minutes} min",
        sessionDurationHours: "{hours}h {minutes}min",
        sessionParticipants: "Partecipanti",
        sessionParticipantsCount: "Partecipanti ({count})",
        today: "Oggi",
        yesterday: "Ieri",
    },
    form: {
