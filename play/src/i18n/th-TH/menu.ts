...
const menu: DeepPartial<Translation["menu"]> = {
    ...
    moderation: {
        ...
        description: "ผู้ที่ถูกแบนจากโลกนี้ การยกเลิกแบนจะทำให้พวกเขากลับเข้ามาได้ด้วยบัญชีใดก็ได้",
        loading: "กำลังโหลด…",
        empty: "ไม่มีใครถูกแบนจากโลกนี้",
        error: "โหลดรายการแบนไม่สำเร็จ ลองอีกครั้ง",
        name: "ผู้ใช้",
        reason: "เหตุผล",
        bannedAt: "แบนเมื่อ",
        bannedBy: "แบนโดย",
