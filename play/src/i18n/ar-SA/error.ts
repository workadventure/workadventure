...
const error: DeepPartial<Translation["error"]> = {
    accessLink: {
        ...
        details:
            "لمزيد من المعلومات، يرجى الاتصال بالمسؤولين أو الاتصال بنا على: hello@workadventu.re", // For more information, please contact the administrators or reach out to us at: hello@workadventu.re
    },
    connectionRejected: {
    ...
    connectionRetry: {
        unableConnect:
            "تعذر الاتصال بـ WorkAdventure. يرجى التأكد من أنك متصل بالإنترنت.", // Unable to connect to WorkAdventure. Please ensure you are connected to the internet.
    },
    errorDialog: {
        title: "خطأ 😱", // Error 😱
        hasReportIssuesUrl:
            "لمزيد من المعلومات، يرجى الاتصال بالمسؤولين أو الإبلاغ عن خطأ على:", // For more information, please contact the administrators or report an error at:
