...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    poll: {
        ...
        create: {
            ...
            removeAnswer: "إزالة الإجابة {index}",
    ...
    roomPanel: {
        ...
        home: {
            directRoom: "غرفة مباشرة",
            groupRoom: "غرفة جماعية",
            encrypted: "مشفرة",
            notEncrypted: "غير مشفرة",
        ...
        settings: {
            ...
            topic: "الموضوع",
            joinRule: "الوصول",
            restrictedTo: "مقيدة بـ",
            restrictedUnavailable: "هذه الغرفة غير مرتبطة بمجلد أو مساحة.",
            readOnly: "هذه الإعدادات للقراءة فقط هنا.",
            unknown: "غير معروف",
            save: "حفظ",
            saving: "جارٍ الحفظ...",
            ...
            errors: {
                roomNameEmpty: "لا يمكن أن يكون اسم الغرفة فارغًا",
                restrictedAccessNeedsParentSpace: "يتطلب الوصول المقيد مجلدًا أو مساحة مرتبطة.",
            },
            joinRules: {
                public: "عام",
                invite: "بدعوة فقط",
            ...
            permissions: {
                ...
                sendReactions: "إرسال التفاعلات",
                redactOwnMessages: "حذف رسائلك",
                redactOtherMessages: "حذف رسائل الآخرين",
                kickUsers: "طرد المستخدمين",
                banUsers: "حظر المستخدمين",
                inviteUsers: "دعوة المستخدمين",
                changeSettings: "تغيير الإعدادات",
                changeRoomName: "تغيير اسم الغرفة",
                changeRoomTopic: "تغيير موضوع الغرفة",
                changeHistoryVisibility: "تغيير ظهور السجل",
