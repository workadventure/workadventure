...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    chooseDeviceVerificationMethodModal: {
        ...
        withQrCode: "عرض رمز QR للمسح الضوئي",
    ...
    verificationQrCodeDialog: {
        ...
        scanInstruction: "امسح رمز QR هذا بجهازك الآخر (مثل تطبيق Element للهاتف المحمول).",
        reciprocateQuestion: "هل قام جهازك الآخر بمسح الرمز وأظهر درعًا أخضر؟",
        reciprocateYes: "نعم",
        reciprocateNo: "لا",
        cancel: "إلغاء",
        success: "تم التحقق من جهازك الآن.",
        cancelled: "تم إلغاء عملية التحقق.",
        unsupported: "لا يمكن لجهازك الآخر مسح رمز QR. جرّب التحقق باستخدام الرموز التعبيرية بدلاً من ذلك.",
        error: "تعذّر إنشاء رمز QR.",
    },
