...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    timeLine: {
        ...
        sessionSummary: "جلسة مع {count} مشارك",
        sessionInProgress: "قيد التنفيذ",
        sessionViewHistory: "عرض السجل",
        sessionStartedAt: "بدأت في {date}",
        sessionEndedAt: "انتهت في {date}",
        sessionDuration: "{minutes} دقيقة",
        sessionDurationHours: "{hours}س {minutes}د",
        sessionParticipants: "المشاركون",
        sessionParticipantsCount: "المشاركون ({count})",
        today: "اليوم",
        yesterday: "أمس",
    },
    form: {
