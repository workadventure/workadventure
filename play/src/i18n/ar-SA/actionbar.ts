...
const actionbar: DeepPartial<Translation["actionbar"]> = {
    ...
    microphone: {
        ...
        loudEnvironmentWarning: "يلتقط الميكروفون الكثير من الصوت. يمكنك تفعيل كتم الضوضاء أو إيقاف تشغيل الميكروفون.",
        enableNoiseSuppression: "تفعيل كتم الضوضاء",
        turnOffMicrophone: "إيقاف تشغيل الميكروفون",
