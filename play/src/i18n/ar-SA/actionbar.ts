...
const actionbar: DeepPartial<Translation["actionbar"]> = {
    ...
    desktop: {
        section: "تطبيق سطح المكتب",
        changeWorld: "تغيير العالم",
        title: "فتح عالم آخر",
        description: "الصق عنوان URL الكامل لعالم WorkAdventure الذي تريد فتحه.",
        urlLabel: "عنوان URL للعالم",
        urlPlaceholder: "https://play.workadventu.re/@/...",
        urlRequired: "يرجى إدخال عنوان URL لعالم.",
        unavailable: "التنقل بين العوالم متاح فقط في تطبيق سطح المكتب.",
        openFailed: "تعذر فتح هذا العالم.",
        openAction: "فتح العالم",
        opening: "جارٍ الفتح...",
        createTitle: "هل تحتاج إلى عالم جديد؟",
        createDescription: "أنشئ مساحة جديدة وقم بإعدادها من وحدة إدارة WorkAdventure.",
        createAction: "إنشاء عالمي",
        openingSignup: "جارٍ فتح صفحة التسجيل...",
        signupFailed: "تعذر فتح صفحة التسجيل.",
    },
