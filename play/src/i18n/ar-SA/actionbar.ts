...
const actionbar: DeepPartial<Translation["actionbar"]> = {
    ...
    speaker: {
        ...
        noDevicesDesc:
            "لا يعرض المتصفح أي مخرجات صوت يمكن اختيارها. بعض المتصفحات تقتصر على ذلك (مثل Safari). جرّب متصفحًا آخر، أو أعد توصيل سماعات الرأس أو السماعات، أو تحقق من إعدادات صوت النظام.",
    },
    status: {
        ONLINE: "متصل",
        AWAY: "بعيد",
