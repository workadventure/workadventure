...
const actionbar: DeepPartial<Translation["actionbar"]> = {
    ...
    desktop: {
        section: "Aplicació d'escriptori",
        changeWorld: "Canviar de món",
        title: "Obrir un altre món",
        description: "Enganxa l'URL complet del món de WorkAdventure que vols obrir.",
        urlLabel: "URL del món",
        urlPlaceholder: "https://play.workadventu.re/@/...",
        urlRequired: "Introdueix l'URL d'un món.",
        unavailable: "La navegació entre mons només està disponible a l'aplicació d'escriptori.",
        openFailed: "No s'ha pogut obrir aquest món.",
        openAction: "Obrir el món",
        opening: "Obrint...",
        createTitle: "Necessites un món nou?",
        createDescription: "Crea i configura un espai nou des de la consola d'administració de WorkAdventure.",
        createAction: "Crear el meu món",
        openingSignup: "Obrint el registre...",
        signupFailed: "No s'ha pogut obrir la pàgina de registre.",
    },
