...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    chooseDeviceVerificationMethodModal: {
        ...
        withQrCode: "Mostra un codi QR per escanejar",
        withPassphrase: "Verificar amb la frase de contrasenya de seguretat",
    },
    verificationQrCodeDialog: {
        title: "Verifica amb codi QR",
        preparing: "S'està preparant el codi QR…",
        scanInstruction: "Escaneja aquest codi QR amb l'altre dispositiu (per exemple, l'aplicació mòbil d'Element).",
        reciprocateQuestion: "L'altre dispositiu ha escanejat el codi i ha mostrat un escut verd?",
        reciprocateYes: "Sí",
        reciprocateNo: "No",
        cancel: "Cancel·la",
        success: "El vostre dispositiu ja està verificat.",
        cancelled: "La verificació s'ha cancel·lat.",
        unsupported: "L'altre dispositiu no pot escanejar un codi QR. Proveu de verificar amb emojis.",
        error: "No s'ha pogut generar el codi QR.",
    },
