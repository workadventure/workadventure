...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    poll: {
        ...
        create: {
            ...
            removeAnswer: "Elimina la resposta {index}",
    ...
    roomPanel: {
        ...
        home: {
            directRoom: "Sala directa",
            groupRoom: "Sala de grup",
            encrypted: "Xifrada",
            notEncrypted: "No xifrada",
            readOnly: "Només lectura",
        },
        settings: {
            roomType: "Tipus de sala",
            encryption: "Xifratge",
            topic: "Tema",
            joinRule: "Accés",
            restrictedTo: "Restringida a",
            restrictedUnavailable: "Aquesta sala no està vinculada a cap carpeta ni espai.",
            readOnly: "Aquesta configuració és només de lectura aquí.",
            unknown: "Desconegut",
            save: "Desa",
            saving: "S'està desant...",
            saveSuccess: "Configuració desada",
            saveError: "No s'ha pogut desar la configuració",
            errors: {
                roomNameEmpty: "El nom de la sala no pot estar buit",
                restrictedAccessNeedsParentSpace: "L'accés restringit requereix una carpeta o un espai enllaçat.",
            },
            joinRules: {
                public: "Pública",
                invite: "Només amb invitació",
                restricted: "Restringida",
                knock: "Sol·licita accés",
            },
            permissions: {
                title: "Permisos",
                sendMessages: "Enviar missatges",
                sendReactions: "Enviar reaccions",
                redactOwnMessages: "Eliminar missatges propis",
                redactOtherMessages: "Eliminar missatges d'altres persones",
                kickUsers: "Expulsar usuaris",
                banUsers: "Bloquejar usuaris",
                inviteUsers: "Convidar usuaris",
                changeSettings: "Canviar configuració",
                changeRoomName: "Canviar nom de la sala",
                changeRoomTopic: "Canviar tema de la sala",
                changeHistoryVisibility: "Canviar visibilitat de l'historial",
                changeAccess: "Canviar accés",
