...
const recording: DeepPartial<Translation["recording"]> = {
    ...
    notification: {
        ...
        startFailedNotification: "Error en iniciar l'enregistrament",
        stopFailedNotification: "Error en aturar l'enregistrament",
        ...
        unexpectedlyStoppedNotification: "La gravació s'ha aturat de manera inesperada",
