...
const actionbar: BaseTranslation = {
    ...
    desktop: {
        ...
        description: "Paste the complete URL of the WorkAdventure world you want to open.",
        urlLabel: "World URL",
        urlPlaceholder: "https://play.workadventu.re/@/...",
        urlRequired: "Please enter a world URL.",
        unavailable: "World navigation is not available outside the desktop app.",
        openFailed: "This world could not be opened.",
        openAction: "Open world",
        opening: "Opening...",
        createTitle: "Need a new world?",
        createDescription: "Create and configure a new space from the WorkAdventure administration console.",
        createAction: "Create my world",
        openingSignup: "Opening signup...",
        signupFailed: "The signup page could not be opened.",
    },
