...
const chat: BaseTranslation = {
    ...
    chooseDeviceVerificationMethodModal: {
        ...
        withQrCode: "Show a QR code to scan",
        withPassphrase: "Verify with security passphrase",
    },
    verificationQrCodeDialog: {
        title: "Verify by QR code",
        preparing: "Preparing the QR code ...",
        scanInstruction: "Scan this QR code with your other device (for example the Element mobile app).",
        reciprocateQuestion: "Did your other device scan the code and show a green shield?",
        reciprocateYes: "Yes",
        reciprocateNo: "No",
        cancel: "Cancel",
        success: "Your device is now verified.",
        cancelled: "The verification was cancelled.",
        unsupported: "Your other device cannot scan a QR code. Try verifying with emojis instead.",
