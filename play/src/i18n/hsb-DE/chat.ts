...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    chooseDeviceVerificationMethodModal: {
        ...
        withQrCode: "QR kod za skenowanje pokazać",
        withPassphrase: "Z wěstotneju frazu přeglědać",
    },
    verificationQrCodeDialog: {
        title: "Z QR kodom přeglědać",
        preparing: "QR kod so přihotuje…",
        scanInstruction: "Skenuj tutón QR kod ze swojim druhim rjadom (na přikład z mobilnej Element-aplikaciju).",
        reciprocateQuestion: "Je twój druhi rjad kod skenował a zeleny šćit pokazał?",
        reciprocateYes: "Haj",
        reciprocateNo: "Ně",
        cancel: "Přetorhnyć",
        success: "Twoj rjad je nětko přeglědany.",
        cancelled: "Přeglědowanje je so přetorhnyło.",
        unsupported: "Twoj druhi rjad njemóže QR kod skenować. Spytaj město toho z emojis přeglědać.",
        error: "QR kod njeda so generować.",
    },
