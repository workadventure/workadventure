...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    timeLine: {
        ...
        sessionSummary: "Sesija z {count} wobdźělnikami",
        sessionInProgress: "Běži",
        sessionViewHistory: "Historiju pokazać",
        sessionStartedAt: "Zachopjena: {date}",
        sessionEndedAt: "Skónčena: {date}",
        sessionDuration: "{minutes} min",
        sessionDurationHours: "{hours}h {minutes}min",
        sessionParticipants: "Wobdźělnicy",
        sessionParticipantsCount: "Wobdźělnicy ({count})",
        today: "Dźensa",
        yesterday: "Wčera",
    },
    form: {
