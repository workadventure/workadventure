...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    notification: {
        ...
        file: "je dataju pósłał: {fileName}",
        forum: "w forumje",
        in: "w",
    },
    see: "widźeć",
    ...
    poll: {
        ...
        create: {
            ...
            removeAnswer: "Wotmołwu {index} wotstronić",
    ...
    roomPanel: {
        ...
        home: {
            directRoom: "Direktna rumnosć",
            groupRoom: "Skupinska rumnosć",
            encrypted: "Zaklučowany",
            notEncrypted: "Njezaklučowany",
            readOnly: "Jenož čitać",
        },
        settings: {
            roomType: "Družina rumnosće",
            encryption: "Zaklučowanje",
            topic: "Tema",
            joinRule: "Přistup",
            restrictedTo: "Wobmjezowany na",
            restrictedUnavailable: "Tuta rumnosć njeje z rjadowakom abo rumom zwjazana.",
            readOnly: "Tute nastajenja su tu jenož za čitanje.",
            unknown: "Njeznaty",
            save: "Składować",
            saving: "Składuje so...",
            saveSuccess: "Nastajenja składowane",
            saveError: "Nastajenja njedadźa so składować",
            errors: {
                roomNameEmpty: "Mjeno rumnosće njesmě prózdne być",
                restrictedAccessNeedsParentSpace: "Wobmjezowany přistup trjeba zwjazany rjadowak abo rum.",
            },
            joinRules: {
                public: "Zjawny",
                invite: "Jenož z přeprošenjom",
                restricted: "Wobmjezowany",
                knock: "Přistup požadać",
            },
            permissions: {
                title: "Prawa",
                sendMessages: "Powěsće pósłać",
                sendReactions: "Reakcije pósłać",
                redactOwnMessages: "Swójske powěsće zhašeć",
                redactOtherMessages: "Powěsće druhich zhašeć",
                kickUsers: "Wužiwarjow wotpokazać",
                banUsers: "Wužiwarjow zawrěć",
                inviteUsers: "Wužiwarjow přeprosyć",
                changeSettings: "Nastajenja změnić",
                changeRoomName: "Mjeno rumnosće změnić",
                changeRoomTopic: "Temu rumnosće změnić",
                changeHistoryVisibility: "Widźomnosć historije změnić",
                changeAccess: "Přistup změnić",
                changePermissions: "Prawa změnić",
            },
        },
