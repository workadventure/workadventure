...
const actionbar: DeepPartial<Translation["actionbar"]> = {
    ...
    desktop: {
        ...
        changeWorld: "Swět změnić",
        title: "Druhi swět wočinić",
        description: "Zasadźće dospołny URL WorkAdventure-swěta, kotryž chceće wočinić.",
        urlLabel: "URL swěta",
        urlPlaceholder: "https://play.workadventu.re/@/...",
        urlRequired: "Prošu zapodajće URL swěta.",
        unavailable: "Nawigacija po swětach je jenož w desktopowym nałoženju k dispoziciji.",
        openFailed: "Tutón swět njeda so wočinić.",
        openAction: "Swět wočinić",
        opening: "Wočinje so...",
        createTitle: "Trjebaće nowy swět?",
        createDescription: "Wutworće a konfigurujće nowy rum w administraciji WorkAdventure.",
        createAction: "Mój swět wutworić",
        openingSignup: "Registracija so wočinje...",
        signupFailed: "Strona registracije njeda so wočinić.",
    },
