...
export default {
    ...
    movement: {
        title: "移動する",
        descriptionDesktop:
            "矢印キーまたはWASDでキャラクターを移動できます。右クリックでも移動できます。今すぐ移動してみてください！",
        descriptionMobile:
            "ジョイスティックまたはマップをタップしてキャラクターを移動します。今すぐ移動してみてください！",
        next: "次へ",
    },
    communication: {
        title: "コミュニケーションバブル",
    ...
    complete: {
        title: "準備完了です！ 🎉",
        description:
            "{worldName}の基本を学びました！自由に探索し、新しい人と出会い、楽しんでください。必要に応じて、メニューからいつでもヘルプにアクセスできます。",
        finish: "探索を始めましょう！",
    },
