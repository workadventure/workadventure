...
const actionbar: DeepPartial<Translation["actionbar"]> = {
    ...
    desktop: {
        ...
        changeWorld: "ワールドを変更",
        title: "別のワールドを開く",
        description: "開きたい WorkAdventure ワールドの完全な URL を貼り付けてください。",
        urlLabel: "ワールド URL",
        urlPlaceholder: "https://play.workadventu.re/@/...",
        urlRequired: "ワールドの URL を入力してください。",
        unavailable: "ワールドの切り替えはデスクトップアプリでのみ利用できます。",
        openFailed: "このワールドを開けませんでした。",
        openAction: "ワールドを開く",
        opening: "開いています...",
        createTitle: "新しいワールドが必要ですか？",
        createDescription: "WorkAdventure の管理画面から新しいスペースを作成して設定できます。",
        createAction: "ワールドを作成",
        openingSignup: "登録ページを開いています...",
        signupFailed: "登録ページを開けませんでした。",
    },
