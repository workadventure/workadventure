...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    roomPanel: {
        ...
        settings: {
            ...
            joinRule: "アクセス",
            restrictedTo: "制限先",
            restrictedUnavailable: "このルームはフォルダーまたはスペースにリンクされていません。",
            readOnly: "ここではこれらの設定は読み取り専用です。",
            unknown: "不明",
            save: "保存",
            saving: "保存中...",
            ...
            errors: {
                roomNameEmpty: "ルーム名を空にすることはできません",
                restrictedAccessNeedsParentSpace:
                    "制限付きアクセスにはリンクされたフォルダーまたはスペースが必要です。",
            },
            joinRules: {
                public: "公開",
                invite: "招待のみ",
            ...
            permissions: {
                ...
                sendReactions: "リアクションを送信",
                redactOwnMessages: "自分のメッセージを削除",
                redactOtherMessages: "他のユーザーのメッセージを削除",
                kickUsers: "ユーザーをキック",
                banUsers: "ユーザーをBAN",
                inviteUsers: "ユーザーを招待",
                changeSettings: "設定を変更",
                changeRoomName: "ルーム名を変更",
                changeRoomTopic: "ルームトピックを変更",
                changeHistoryVisibility: "履歴の表示範囲を変更",
                changeAccess: "アクセスを変更",
