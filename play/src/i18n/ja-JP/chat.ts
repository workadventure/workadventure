...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    timeLine: {
        ...
        sessionSummary: "{count} 人のセッション",
        sessionInProgress: "進行中",
        sessionViewHistory: "履歴を表示",
        sessionStartedAt: "開始: {date}",
        sessionEndedAt: "終了: {date}",
        sessionDuration: "{minutes} 分",
        sessionDurationHours: "{hours}時間{minutes}分",
        sessionParticipants: "参加者",
        sessionParticipantsCount: "参加者 ({count})",
        today: "今日",
        yesterday: "昨日",
    },
    form: {
