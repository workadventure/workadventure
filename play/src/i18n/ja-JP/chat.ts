...
const chat: DeepPartial<Translation["chat"]> = {
    ...
    chooseDeviceVerificationMethodModal: {
        ...
        withQrCode: "スキャン用のQRコードを表示",
        withPassphrase: "セキュリティパスフレーズで確認する",
    },
    verificationQrCodeDialog: {
        title: "QRコードで検証",
        preparing: "QRコードを準備しています…",
        scanInstruction: "このQRコードをもう一方のデバイス（例：Elementモバイルアプリ）でスキャンしてください。",
        reciprocateQuestion: "もう一方のデバイスがコードをスキャンし、緑色のシールドが表示されましたか？",
        reciprocateYes: "はい",
        reciprocateNo: "いいえ",
        cancel: "キャンセル",
        success: "デバイスが検証されました。",
        cancelled: "検証がキャンセルされました。",
        unsupported: "もう一方のデバイスはQRコードをスキャンできません。代わりに絵文字で検証してください。",
