 ...
 * `sendToPip`) are kept so the app:pip:* relay in ipc.ts and the front's WAD.pip client stay
 * untouched: to the WorkAdventure renderer, "the PiP" is now just the companion.
 */
