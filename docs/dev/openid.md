...
- `OPID_CLIENT_ISSUER`: the full URL to your OpenID Connect provider
- `OPID_CLIENT_ID`: the ID of the OpenID client that you created in the OpenID Connect provider
- `OPID_CLIENT_SECRET`: the secret of the OpenID client that you created in the OpenID Connect provider
