---
sidebar_position: 11
title: Download your Map Locally
---
...
To start this web server, you will need [Node.JS](https://nodejs.org/en/). When it is downloaded, open your command line and from the directory of the map, run this command:
