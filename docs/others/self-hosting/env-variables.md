...
| `TURN_CREDENTIALS_RENEWAL_TIME` | No | Time interval (in milliseconds) for renewing ICE server credentials (TURN/STUN). Defaults to 10800000 milliseconds (3 hours) |
