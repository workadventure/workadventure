...
| `DEFAULT_WOKA_NAME` | Yes | Default name to use for users when they join the room. |
| `DEFAULT_WOKA_TEXTURE` | Yes | Default avatar texture URL to use for users. |
...
| `PROVIDE_DEFAULT_WOKA_NAME` | Yes | How woka names are assigned: 'no' (manual input), 'random' (random name), 'fix' (use DEFAULT_WOKA_NAME), 'fix-plus-random-numbers' (use DEFAULT_WOKA_NAME with random numbers appended). |
| `PROVIDE_DEFAULT_WOKA_TEXTURE` | Yes | How woka textures/avatars are assigned: 'no' (manual selection), 'random' (random texture), 'fix' (use DEFAULT_WOKA_TEXTURE). |
...
| `LIVEKIT_RECORDING_S3_ENDPOINT` | Yes | The S3 endpoint for Livekit recording. |
| `LIVEKIT_RECORDING_S3_ACCESS_KEY` | Yes | The S3 access key for Livekit recording. |
| `LIVEKIT_RECORDING_S3_SECRET_KEY` | Yes | The S3 secret key for Livekit recording. |
| `LIVEKIT_RECORDING_S3_BUCKET` | Yes | The S3 bucket for Livekit recording. |
| `LIVEKIT_RECORDING_S3_REGION` | Yes | The S3 region for Livekit recording. |
| `LIVEKIT_RECORDING_S3_CDN_ENDPOINT` | Yes | The S3 CDN endpoint for Livekit recording. |
